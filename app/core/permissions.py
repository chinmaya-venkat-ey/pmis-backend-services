...
ALL_MASTERS_READ_PERMISSIONS: Final[tuple[str, ...]] = (
    DIVISIONS_READ, VENDORS_READ, RESOURCE_TYPES_READ, DESIGNATIONS_READ,
    PRIORITIES_READ,
    ...
    COST_TYPES_READ, FREQUENCIES_READ, PAYMENT_TYPES_READ,
    CARRY_FORWARD_METHODS_READ,
)

ALL_MASTERS_MANAGE_PERMISSIONS: Final[tuple[str, ...]] = (
    DIVISIONS_MANAGE, VENDORS_MANAGE, RESOURCE_TYPES_MANAGE, DESIGNATIONS_MANAGE,
    PRIORITIES_MANAGE,
    ...
    COST_TYPES_MANAGE, FREQUENCIES_MANAGE, PAYMENT_TYPES_MANAGE,
