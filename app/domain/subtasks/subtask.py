"""Subtask domain entity. Ported verbatim from the monolith.

Subtasks live under tasks (parent FK = task_id) and are **version-only**
per project_lock — only version projects accept subtask writes; baselines
reject them.
"""
...
SUBTASK_TYPES = (
    SUBTASK_TYPE_STANDARD,
    SUBTASK_TYPE_RESOURCE,
    SUBTASK_TYPE_TRANSACTIONAL,
    )
