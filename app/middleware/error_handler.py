...
Duplicated from project-management (simplified — no multipart quirks for
the base file-store service). Keep in sync across PMIS services.
"""
...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    async def domain_error_handler(request: Request, exc: DomainError):
        return api_response(
            ...
            error=format_error(exc.code, exc.message, exc.details or None),
        )
