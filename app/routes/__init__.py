...
project_router.include_router(planned_resource_routes.planned_resource_project_scoped_router)
project_router.include_router(planned_resource_routes.planned_resource_router)
