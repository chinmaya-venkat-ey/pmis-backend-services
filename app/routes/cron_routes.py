...
def daily_digest(
    ...
    controller: Annotated[CronController, Depends(get_cron_controller)] = Depends(get_cron_controller),
    _auth: Annotated[None, Depends(_verify_cron_secret)] = Depends(_verify_cron_secret),
) -> DigestResponse:
