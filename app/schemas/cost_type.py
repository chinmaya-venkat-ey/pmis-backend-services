"""Pydantic v2 schemas for the cost-types catalog.

Code is lowercased server-side (e.g. "Fixed" → "fixed").
"""
...
class CostTypeCreateRequest(BaseModel):
    """Body of POST /master/cost-types/create."""
...
class CostTypeUpdateRequest(BaseModel):
    """Body of PATCH /master/cost-types/{code} — partial."""
...
class CostTypeResponse(ResponseModel):
    """Returned by GET /master/cost-types and /{code}."""
