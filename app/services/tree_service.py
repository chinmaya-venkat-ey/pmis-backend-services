...
class TreeService:
    ...
    def get_project_tree(
        ...
        *,
        ...
        # Meeting milestones are hidden from the project tree (the FE never
        # renders them). Skip even when ``include_deleted=True`` since
        # there's no UX value in surfacing a soft-deleted meeting row.
        milestones = list(
            db.execute(
