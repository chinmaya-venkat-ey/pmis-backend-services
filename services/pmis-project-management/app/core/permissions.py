...
# FSM transition gates (round-7: FSM now keyed by permission code, not role)
...
COMMENTS_MODERATE: Final[str] = "comments:moderate"  # admin/super_admin only (Q8 tombstone)
